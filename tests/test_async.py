...
from osint_ga.utils import get_codes_from_single_timestamp, get_codes_from_snapshots, get_snapshot_timestamps, DEFAULT_HEADERS
...
class AsyncTestCase(asynctest.TestCase):
    ...
    async def test_get_snapshot_timestamps(self, mock_get):
        ...
        # mock_response.text.return_value = "20120101000000\n20130102000000\n20140103000000\n20150104000000\n20160105000000\n20170106000000\n20180107000000\n20190108000000\n20200109000000\n20210110000000"
        ...
        expected_timestamp_list = ["20120101000000", "20130102000000", "20140103000000", "20150104000000", "20160105000000", "20170106000000", "20180107000000", "20190108000000", "20200109000000", "20210110000000"]
        ...
        mock_get.assert_called_with(
            expected_CDX_url, headers=DEFAULT_HEADERS
        )

    @patch("aiohttp.ClientSession.get")
    @patch("osint_ga.utils.get_UA_code")
    @patch("osint_ga.utils.get_GA_code")
    @patch("osint_ga.utils.get_GTM_code")
    @patch("osint_ga.utils.sem", new_callable=MagicMock())
    async def test_get_codes_from_single_timestamp(self, mock_sem, mock_GTM, mock_GA, mock_UA, mock_get):
        ...
        mock_get.assert_called_with(
            expected_url, headers=DEFAULT_HEADERS
        )
